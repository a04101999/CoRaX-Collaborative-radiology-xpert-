...
from models import ChexformerModel
...
model = ChexformerModel(args.num_labels,args.use_lmt,args.pos_emb,args.layers,args.heads,args.dropout,args.no_x_features)
...
for epoch in range(1,args.epochs+1):
    ...
    import numpy as np
    np.save('red',all_preds) 
    np.save('redt',all_targs)
    print(args.model_name)
